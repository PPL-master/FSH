Instance: Inline-Instance-for-10e18b90-c5ff-4921-acae-db0a9f85cc79-4
InstanceOf: PackagedProductDefinition
Usage: #inline
* language = #EE
* extension.url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-PackagedProductDefinition.containedItemQuantity"
* extension.valueQuantity.value = 500
* extension.valueQuantity.unit = "tablets"
* identifier.system = "http://ema.europa.eu/fhir/pcId"
* identifier.value = "EE-mpid-0002"
...
* package.package.containedItem.amountQuantity.value = 500